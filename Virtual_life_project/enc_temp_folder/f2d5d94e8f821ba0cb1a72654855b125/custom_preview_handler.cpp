...
{
    m_custom->GetCustomizableObjectInstance()->SetFloatParameterSelectedOption(FString("OnClick"), 1.0, -1);
...
void Ucustom_preview_handler::OffLeftMouseClick()
{
    ...
    m_custom->GetCustomizableObjectInstance()->SetFloatParameterSelectedOption(FString("OnClick"), 0.0, -1);
