...
Kid::Kid(unsigned int id, unsigned int preg_id, unsigned int spouse_id, const Customizing& cus, char personality, const wchar_t* msg) : id(id), preg_id(preg_id), spouse_id(spouse_id), customizing(cus), personality(personality)
{
